    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>{t({ en: "This page is under construction. You will be able to manage videos here.", ur: "یہ صفحہ زیر تعمیر ہے۔ آپ یہاں ویڈیوز کا نظم کر سکیں گے۔" })}</CardDescription>
            </CardHeader>
            <CardContent>
