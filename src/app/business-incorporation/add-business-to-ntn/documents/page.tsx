...
export default function AddBusinessToNtnDocumentsPage() {
  const { t } = useLanguage();
  ...
  return (
    <AppLayout pageTitle={t({ en: 'Upload Documents', ur: 'دستاویزات اپ لوڈ کریں' })}>
      <div className="max-w-6xl mx-auto">
        <Card>
          <CardHeader>
            <CardTitle>{t({ en: 'Upload Required Documents for NTN', ur: 'این ٹی این کے لیے مطلوبہ دستاویزات اپ لوڈ کریں' })}</CardTitle>
            <CardDescription>
              {t({
