...
export default function RemoveBusinessFromNtnPage() {
  ...
  const handleContinue = () => {
    ...
    toast({
        ...
        description: "NTN Removal service has been added to your cart."
    });
    router.push('/cart');
  };
  ...
  return (
    <AppLayout pageTitle={t({ en: 'Remove Business from NTN', ur: 'این ٹی این سے کاروبار ہٹائیں' })}>
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t({
                en: 'Please provide the required information to remove the business from your NTN.',
                ur: 'براہ کرم اپنے این ٹی این سے کاروبار ہٹانے کے لیے مطلوبہ معلومات فراہم کریں۔',
              })}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <Input id="businessName" placeholder={t({ en: 'e.g., Old Ventures Inc.', ur: 'مثلاً، اولڈ وینچرز انکارپوریٹڈ' })} />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                         <Label htmlFor="cessationDate">{t({ en: 'Cessation Date', ur: 'بند ہونے کی تاریخ' })}</Label>
                        <Popover>
